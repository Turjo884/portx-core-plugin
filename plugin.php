<?php
namespace Portx_Core_Help;

use Portx_Core_Help\PageSettings\Page_Settings;
...
class Plugin {
	...
	public function widget_scripts() {
		wp_register_script( 'portx-core', plugins_url( '/assets/js/hello-world.js', __FILE__ ), [ 'jquery' ], false, true );
	}
